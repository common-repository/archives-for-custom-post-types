...
**DEPRECATION NOTICE:** As of WordPress 4.4, you no longer need this plugin as `wp_get_archives()` now accepts custom post types as an argument. See [#34686](https://core.trac.wordpress.org/ticket/21596).
